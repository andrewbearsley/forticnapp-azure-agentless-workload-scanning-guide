...
Save this file securely (e.g., `lacework-credentials.json`).

## Configuration

Configure the CLI using the JSON file with your API credentials:
...
- [Lacework CLI Documentation](https://docs.fortinet.com/document/forticnapp/latest/cli-reference)
